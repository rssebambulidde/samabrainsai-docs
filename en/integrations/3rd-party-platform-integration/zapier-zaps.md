---
description: Learn how to integrate SamaFlow and Zapier
---
...
2. Refer [deployment](../../configuration/deployment/) to create a cloud hosted version of SamaFlow.
...
### SamaFlow generate Result Message

1.  Click **+**, click or search for **SamaFlow**
...
3.  Click **Sign in** and insert your details, then click **Yes, Continue to SamaFlow**
...
4.  Select your prefered Channel for channel and select **Text** and **String Source** (if available) from SamaFlow for Message Text, then click **Continue**
