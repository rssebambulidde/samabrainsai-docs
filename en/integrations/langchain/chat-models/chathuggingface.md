...
To get started, you need to deploy SamaFlow. Install and run SamaFlow, either locally or on the cloud. You can follow the official SamaFlow documentation or tutorials for deployment.

To create a chatflow in SamaFlow with a ChatHuggingFace chat model:
...
8.  Voila [🎉](https://emojipedia.org/party-popper/), you have created a chatflow with a **ChatHuggingFace node** in SamaFlow.
