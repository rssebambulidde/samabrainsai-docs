...
3. Voila [🎉](https://emojipedia.org/party-popper/), you can now use **ChatOllama node** in SamaFlow

<figure><img src="../../../.gitbook/assets/image (141).png" alt=""><figcaption></figcaption></figure>

### Running on Docker

If you are running both SamaFlow and Ollama on docker. You'll have to change the Base URL for ChatOllama.
...
2. In SamaFlow, click **Create Credential** and select **Ollama API**, and enter your API Key.
