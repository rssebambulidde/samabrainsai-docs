...
1. Go to Credential page on SamaFlow and click **"Add credential"**
...
5. **🎉**You can now use ChatGoogleVertexAI with the credential in SamaFlow now!
...
* [Try Google Vertex AI Palm 2 with SamaFlow: Without Coding to Leverage Intuition](https://tech.beatrust.com/entry/2023/08/22/Try_Google_Vertex_AI_Palm_2_with_Flowise%3A_Without_Coding_to_Leverage_Intuition)
