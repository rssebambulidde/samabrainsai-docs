...
[Spider](https://spider.cloud/?ref=samaflow) is the fastest open source web scraper & crawler that returns LLM-ready data. To get started using this node you need an API key from [Spider.cloud](https://spider.cloud/?ref=samaflow).

## Get Started

1. Go to the [Spider.cloud](https://spider.cloud/?ref=samaflow) website and sign up for a free account.
