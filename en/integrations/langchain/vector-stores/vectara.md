...
1. Register an account for [Vectara](https://vectara.com/integrations/samaflow)
...
5. Back to SamaFlow canvas, and create your chatflow. Click **Create New** from the Credentials dropdown ane enter your Vectara credentials.
