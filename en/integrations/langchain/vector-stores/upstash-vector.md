...
3.  Do the necessary configurations and create the index.
    ...
    1. **Index Name**, name of the index to be created. (e.g. "samaflow-upstash-demo")
...
<figure><img src="../../../.gitbook/assets/upstash/samaflow-design.jpeg" alt=""><figcaption></figcaption></figure>
