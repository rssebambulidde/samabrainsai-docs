...
To use AWS Bedrock in SamaFlow, add the **AWS Bedrock LLM** node to your Chatflow. 

# Setup

1. Configure AWS credentials for SamaFlow.

In Amazon Bedrock, ensure that your account has access to the model you want to use with SamaFlow. 

2. Add the AWS Bedrock node to your Chatflow.

In the SamaFlow canvas, drag and drop the AWS Bedrock LLM node into your Chatflow. 
...
For information about deploying SamaFlow on AWS, see [AWS](../../../configuration/deployment/aws.md).
