---
description: Learn how SamaFlow integrates with LiteLLM Proxy
---

# LiteLLM Proxy

Use [LiteLLM Proxy](https://docs.litellm.ai/docs/simple_proxy) with SamaFlow to:
...
## How to use LiteLLM Proxy with SamaFlow
...
### Step 3: Use the LiteLLM Proxy in SamaFlow

In SamaFlow, specify the **standard OpenAI nodes (not the Azure OpenAI nodes)** -- this goes for **chat models, embeddings, llms -- everything**
