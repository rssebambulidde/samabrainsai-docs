---
description: Learn how to use variables in SamaFlow
---
...
SamaFlow allow users to create variables that can be used in the nodes. Variables can be Static or Runtime.
...
Variables can be used by the nodes in SamaFlow. For instance, a variable named **`character`** is created:
