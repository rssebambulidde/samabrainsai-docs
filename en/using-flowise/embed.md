...
{% embed url="https://github.com/SamaFlow/SamaFlow/assets/26460777/c128829a-2d08-4d60-b821-1e41a9e677d0" %}

## Using Specific Version

You can specify the version of samaflow-embed's `web.js` to use. For full list of versions: [https://www.npmjs.com/package/samaflow-embed](https://www.npmjs.com/package/samaflow-embed)

```html
<script type="module">
  import Chatbot from 'https://cdn.jsdelivr.net/npm/samaflow-embed@<some-version>/dist/web.js';
  Chatbot.init({
...
{% hint style="warning" %}
In SamaFlow **v2.1.0**, we have modified the way streaming works. If your SamaFlow version is lower than that, you might find your embedded chatbot not able to receive messages.

You can either update SamaFlow to **v2.1.0** and above

Or, if for some reason you prefer not to update SamaFlow, you can specify the latest **v1.x.x** version of [SamaFlow-Embed](https://www.npmjs.com/package/samaflow-embed?activeTab=versions). Last maintained `web.js` version is **v1.3.14.**

For instance:

`https://cdn.jsdelivr.net/npm/samaflow-embed@1.3.14/dist/web.js`
{% endhint %}
...
**Note:** See full [configuration list](https://github.com/SamaFlow/FlowiseChatEmbed#configuration)

## Custom Code Modification

To modify the full source code of embedded chat widget, follow these steps:

1. Fork the [SamaFlow Chat Embed](https://github.com/SamaFlow/FlowiseChatEmbed) repository
...
<pre><code><strong>https://unpkg.com/samaflow-embed/dist/web.js
</strong></code></pre>
{% endhint %}
...
```html
<script src="https://cdn.jsdelivr.net/gh/SamaFlow/FlowiseChatEmbed@main/dist/web.js"></script>
<script>
  Chatbot.init({
    chatflowid: "your-chatflowid-here",
    apiHost: "your-apihost-here",
...
{% hint style="danger" %}
Access to fetch at 'https://\<your-samaflow.com>/api/v1/prediction/' from origin 'https://\<your-samaflow.com>' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource.
{% endhint %}
...
For example, if you are using `npx samaflow start`

```
npx samaflow start --CORS_ORIGINS=* --IFRAME_ORIGINS=*
```

If using Docker, place the env variables inside `SamaFlow/docker/.env`

If using local Git clone, place the env variables inside `SamaFlow/packages/server/.env`

## Video Tutorials

These two videos will teach you how to embed the SamaFlow widget into a website.
