...
Prediction API is the primary endpoint for interacting with your SamaFlow flows and assistants. It allows you to send messages to your selected flow and receive responses back. This API handles the core chat functionality, including:
...
**Base URL**: `http://localhost:3000` (or your SamaFlow instance URL)
...
SamaFlow provides official SDKs for Python and TypeScript/JavaScript:

#### Installation

**Python**: `pip install samaflow`

**TypeScript/JavaScript**: `npm install samaflow-sdk`
...
# Initialize client
client = SamaFlow(base_url="http://localhost:3000")
...
{% tab title="Basic Usage" %}
```typescript
import { FlowiseClient } from 'samaflow-sdk';
...
SamaFlow Chat UI reads `action.elements` and renders buttons based on element `type`:
