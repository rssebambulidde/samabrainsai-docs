...
First, install Git and clone SamaFlow repository. You can follow the steps from the [Get Started](/broken/pages/nuiTj70UthEELOvhLrSb#for-developers) guide.

### Structure

SamaFlow separate every node integration under the folder `packages/components/nodes`. Let's try to create a simple Tool!
