---
description: Welcome to the official SamaFlow documentation
---
...
SamaFlow is an open source generative AI development platform for building AI Agents and LLM workflows.
...
Agentflow is the superset of Chatflow & Assistant. It can be used to create chat assistant, single-agent system, multi-agent systems, and complex workflow orchestration. Learn more [Agentflow V2](using-samaflow/agentflowv2.md)
...
## SamaFlow Capabilities

| Feature Area                 | SamaFlow Capabilities                                                                                                |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------- |
...
If you want to help this project, please consider reviewing the [Contribution Guide](https://github.com/SamaFlow/SamaFlow/blob/main/CONTRIBUTING.md).
