---
description: Learn how to set up app-level access control for your SamaFlow instances
---
...
* `APP_URL` - Your hosted SamaFlow appication URL. Default to `http://localhost:3000`

### JWT Environment Variables Configuration

To configure SamaFlow's JWT authentication parameters, user may alter the following environment variables:
...
* `EXPRESS_SESSION_SECRET` - Session encryption secret (default: 'samaflow')
...
App level authorization protects your SamaFlow instance by username and password. This protects your apps from being accessible by anyone when deployed online.
...
2. Start SamaFlow with username & password

```bash
npx samaflow start --FLOWISE_USERNAME=user --FLOWISE_PASSWORD=1234
```
