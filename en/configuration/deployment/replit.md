---
description: Learn how to deploy SamaFlow on Replit
---
...
6. Type in `npm install -g samaflow` into the Shell terminal window. If you are having error about incompatible node version, use the following command `yarn global add samaflow --ignore-engines`
