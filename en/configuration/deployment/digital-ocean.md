...
You have successfully setup SamaFlow on your Droplet, with SSL certificate on your domain [🥳](https://emojipedia.org/partying-face/)

## Steps to update SamaFlow on Digital Ocean

1. Navigate to the directory you installed samaflow in
...
3. Pull the latest SamaFlow Image

You can check the latest version release [here](https://github.com/SamaFlow/SamaFlow/releases)
