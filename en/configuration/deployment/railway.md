---
description: Learn how to deploy SamaFlow on Railway
---
...
That's it! You now have a deployed SamaFlow on Railway [🎉](https://emojipedia.org/party-popper/)[🎉](https://emojipedia.org/party-popper/)

## Persistent Volume

The default filesystem for services running on Railway is ephemeral. SamaFlow data isn’t persisted across deploys and restarts. To solve this issue, we can use [Railway Volume](https://docs.railway.app/reference/volumes).
...
* DATABASE\_PATH - `/opt/railway/.samaflow`
* APIKEY\_PATH - `/opt/railway/.samaflow`
* LOG\_PATH - `/opt/railway/.samaflow/logs`
* SECRETKEY\_PATH - `/opt/railway/.samaflow`
* BLOB\_STORAGE\_PATH - `/opt/railway/.samaflow/storage`
...
Now try creating a flow and save it in SamaFlow. Then try restarting service or redeploy, you should still be able to see the flow you have saved previously.
