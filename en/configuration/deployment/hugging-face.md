---
description: Learn how to deploy SamaFlow on Hugging Face
---
...
5. _(Optional)_ Fill in with your environment variables, such as database credentials, file paths, etc. You can check for valid fields in the `.env.example` [here](https://github.com/SamaFlow/SamaFlow/blob/main/docker/.env.example)
