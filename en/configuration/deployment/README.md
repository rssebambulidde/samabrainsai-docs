---
description: Learn how to deploy SamaFlow to the cloud
---
...
SamaFlow is designed with a platform-agnostic architecture, ensuring compatibility with a wide range of deployment environments to suit your infrastructure needs.

## Local Machine

To deploy SamaFlow locally, follow our [Get Started](../../getting-started/) guide.
