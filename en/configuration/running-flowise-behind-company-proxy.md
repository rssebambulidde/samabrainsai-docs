# Running SamaFlow behind company proxy

If you're running SamaFlow in an environment that requires a proxy, such as within an organizational network, you can configure SamaFlow to route all its backend requests through a proxy of your choice. This feature is powered by the `global-agent` package.

[https://github.com/gajus/global-agent](https://github.com/gajus/global-agent)

## Configuration

There are 2 environment variables you will need to run SamaFlow behind a company proxy:
