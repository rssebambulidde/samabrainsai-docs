---
description: Learn how to connect your SamaFlow instance to a database
---
...
SamaFlow supports 4 database types:
...
DATABASE_PATH=/root/.samaflow #your preferred location
```

A `database.sqlite` file will be created and saved in the path specified by `DATABASE_PATH`. If not specified, the default store path will be in your home directory -> .samaflow
...
### How to use SamaFlow databases SQLite and MySQL/MariaDB

{% embed url="https://youtu.be/R-6uV1Cb8I8" %}

## Backup

1. Shut down SamaFlow application.
...
3. Test backup database by running SamaFlow.
...
3. Create test database.
   ...
   ```
4. Test the backup database by running SamaFlow with the `.env` file modified to point to the backup database.
