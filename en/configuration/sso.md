...
SamaFlow supports [OIDC](https://openid.net/) that allows users to use _single sign_-on (_SSO_) to access application. Currently only the [Organization Admin](../using-samaflow/workspaces.md#setting-up-admin-account) can configure the SSO configurations.
...
8. Fill in the redirect URIs. This will need to be changed depending on how you are hosting it: `http[s]://[your-samaflow-instance.com]/api/v1/azure/callback`:
...
10. Back to SamaFlow app, login as Organization Admin. Navigate to SSO Config from left side bar. Fill in the Azure Tenant ID and Client ID from Step 4, and Client Secret from Step 6. Click Test Configuration to see if the connection can be established successfully:
...
4\. Fill in the redirect URIs. This will need to be changed depending on how you are hosting it: `http[s]://[your-samaflow-instance.com]/api/v1/google/callback`:
...
6\. Back to SamaFlow app, add the Client ID and secret. Test the connection and Save it.
...
4\. Fill in the Application URIs. This will need to be changed depending on how you are hosting it: `http[s]://[your-samaflow-instance.com]/api/v1/auth0/callback`:
...
6\. Back to SamaFlow App, fill in the Domain, Client ID and Secret. Test and Save the configuration.

<figure><img src="../.gitbook/assets/image (234).png" alt="" width="563"><figcaption></figcaption></figure>

## Inviting users for SSO sign in

In order for new user to be able to login, you have to invite new users into SamaFlow application. This is essential to keep a record of the role/workspace of the invited user. Refer to [Invite Users](../using-samaflow/workspaces.md#invite-user) section for env variables configuration.
...
Clicking the button will bring the invited user directly to SamaFlow SSO login screen:

<figure><img src="../.gitbook/assets/image (210).png" alt="" width="400"><figcaption></figcaption></figure>

Or navigate to SamaFlow app and Sign in with SSO:
