...
This tutorial walks you through creating a custom tool in SamaFlow that calls a webhook endpoint, passing the necessary parameters in the request body. We will use [Make.com](https://www.make.com/en) to set up a webhook workflow that sends messages to a Discord channel.
...
## Creating a Webhook Tool in SamaFlow

Next, we will create a custom tool in SamaFlow to send webhook requests.

### Step 1: Add a New Tool

1. Open the **SamaFlow** dashboard.
2. Click **Tools**, then select **Create**.

   <figure><img src="../.gitbook/assets/screely-1691758397783.png" alt="Creating tool in SamaFlow"><figcaption></figcaption></figure>
...
3. Fill in the following fields:
   ...
   | **Tool Icon Src** | [SamaFlow Tool Icon](https://github.com/SamaFlow/SamaFlow/assets/26460777/517fdab2-8a6e-4781-b3c8-fb92cc78aa0b) |
...
- Watch a step-by-step guide on using webhooks with SamaFlow custom tools:
  {% embed url="https://youtu.be/_K9xJqEgnrU" %}

- Learn how to connect SamaFlow to Google Sheets using webhooks:
  {% embed url="https://youtu.be/fehXLdRLJFo" %}

- Learn how to connect SamaFlow to Microsoft Excel using webhooks:
