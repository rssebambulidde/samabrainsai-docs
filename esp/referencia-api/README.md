...
Usando la API pública de SamaFlow, puedes ejecutar programáticamente muchas de las mismas tareas que puedes hacer en la interfaz gráfica. Esta sección introduce la API REST de SamaFlow.
