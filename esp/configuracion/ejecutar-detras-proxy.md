# Ejecutando SamaFlow detrás de un proxy corporativo

Si estás ejecutando SamaFlow en un entorno que requiere un proxy, como dentro de una red organizacional, puedes configurar SamaFlow para enrutar todas sus solicitudes backend a través de un proxy de tu elección. Esta funcionalidad está impulsada por el paquete `global-agent`.

[https://github.com/gajus/global-agent](https://github.com/gajus/global-agent)

## Configuración

Hay 2 variables de entorno que necesitarás para ejecutar SamaFlow detrás de un proxy corporativo:
