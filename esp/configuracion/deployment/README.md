---
description: Aprende cómo hacer deployment de SamaFlow a la cloud
---
...
SamaFlow está diseñado con una platform-agnostic architecture, asegurando compatibilidad con una amplia gama de deployment environments para adaptarse a tus necesidades de infrastructure.

## Local Machine

Para hacer deployment de SamaFlow localmente, sigue nuestra guía [Get Started](../../getting-started/).
...
* [GCP](gcp.md)
* [Kubernetes using Helm](https://artifacthub.io/packages/helm/cowboysysop/samaflow)
