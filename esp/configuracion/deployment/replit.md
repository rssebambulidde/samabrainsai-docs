---
description: Aprende cómo hacer deployment de SamaFlow en Replit
---
...
6. Escribe `npm install -g samaflow` en la ventana de terminal Shell. Si tienes un error sobre una versión de node incompatible, usa el siguiente comando `yarn global add samaflow --ignore-engines`
