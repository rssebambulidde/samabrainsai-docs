...
1. Haz click en el botón de abajo para hacer deploy de SamaFlow en Railway
...
El filesystem por defecto para servicios corriendo en Railway es efímero. Los datos de SamaFlow no persisten entre deploys y reinicios. Para resolver este problema, podemos usar [Railway Volume](https://docs.railway.app/reference/volumes).
...
* DATABASE_PATH - `/opt/railway/.samaflow`
* LOG_PATH - `/opt/railway/.samaflow/logs`
* SECRETKEY_PATH - `/opt/railway/.samaflow`
* BLOB_STORAGE_PATH - `/opt/railway/.samaflow/storage`
...
Ahora intenta crear un flujo y guardarlo en SamaFlow. Luego intenta reiniciar el servicio o hacer redeploy, deberías poder ver el flujo que guardaste previamente.
