...
You can deploy SamaFlow on AWS ECS using our CloudFormation template. The template will create:
...
4. Upload the `cloudformation.yaml` file from the [SamaFlow repository](https://github.com/SamaFlow/SamaFlow/blob/main/docker/cloudformation.yaml)
5. Click **Next**
...
After deployment, the URL of your SamaFlow application will be available in the CloudFormation stack outputs.
