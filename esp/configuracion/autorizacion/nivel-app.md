---
description: Aprende cómo configurar el control de acceso a nivel de aplicación para tus instancias de SamaFlow
---
...
* `APP_URL` - La URL de tu aplicación SamaFlow alojada. Por defecto `http://localhost:3000`

### Configuración de Variables de Entorno JWT

Para configurar los parámetros de autenticación JWT de SamaFlow, el usuario puede modificar las siguientes variables de entorno:
...
* `EXPRESS_SESSION_SECRET` - Secreto de encriptación de sesión (por defecto: 'samaflow')
...
La autorización a nivel de aplicación protege tu instancia de SamaFlow mediante username y password. Esto protege tus apps de ser accesibles por cualquier persona cuando están deployed online.
...
2. Start SamaFlow con username y password
