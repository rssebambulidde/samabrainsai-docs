---
description: Aprende cómo SamaFlow se integra con LiteLLM Proxy
---

# LiteLLM Proxy

Usa [LiteLLM Proxy](https://docs.litellm.ai/docs/simple_proxy) con SamaFlow para:
...
## Cómo usar LiteLLM Proxy con SamaFlow
...
### Paso 3: Usa el LiteLLM Proxy en SamaFlow

En SamaFlow, especifica los **nodos estándar de OpenAI (no los nodos de Azure OpenAI)** -- esto aplica para **modelos de chat, embeddings, llms -- todo**
