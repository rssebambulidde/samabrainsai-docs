...
[Spider](https://spider.cloud/?ref=samaflow) es el web scraper y crawler de código abierto más rápido que devuelve datos preparados para LLM. Para comenzar a usar este nodo necesitas una clave API de [Spider.cloud](https://spider.cloud/?ref=samaflow).

## Comenzar

1. Ve al sitio web de [Spider.cloud](https://spider.cloud/?ref=samaflow) y regístrate para obtener una cuenta gratuita.
