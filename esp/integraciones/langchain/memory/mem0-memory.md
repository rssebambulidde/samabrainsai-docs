...
## Uso de Mem0 con SamaFlow

Sigue estos pasos para integrar Mem0 con SamaFlow:

### 1. Configurar SamaFlow

1. Abre la aplicación SamaFlow y crea un nuevo lienzo o selecciona una plantilla del mercado de SamaFlow.
...
<figure><img src="../../../.gitbook/assets/mem0/samaflow-flow.png" alt="Integración de SamaFlow con Mem0"><figcaption>Integración de SamaFlow con Mem0</figcaption></figure>
...
### 3. Configurar credenciales de Mem0 en SamaFlow
...
1. Guarda tu configuración de SamaFlow.
2. Ejecuta una prueba de chat y almacena información.

<figure><img src="../../../.gitbook/assets/mem0/samaflow-chat-1.png" alt="Prueba de chat en SamaFlow"><figcaption>Prueba de almacenamiento de memoria</figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/mem0/samaflow-memory.png" alt="Memorias almacenadas en Mem0"><figcaption>Revisión de recuerdos almacenados</figcaption></figure>

### 6. Validar la retención de memoria

1. Borra el historial de chat en SamaFlow.
2. Haz una pregunta basada en información previamente almacenada para confirmar la retención.

<figure><img src="../../../.gitbook/assets/mem0/samaflow-chat-2.png" alt="Prueba de retención de memoria"><figcaption>Confirmación de persistencia de memoria</figcaption></figure>
...
## Configurar credenciales de Mem0 en SamaFlow

Para agregar credenciales en SamaFlow:
...
<figure><img src="../../../.gitbook/assets/mem0/api-key.png" alt="Agregar clave de API en SamaFlow"><figcaption>Introducir clave de API en SamaFlow</figcaption></figure>

---

Con estas configuraciones, tu configuración de SamaFlow se integrará perfectamente con Mem0, proporcionando una mejor retención de memoria e interacciones de IA personalizadas.
