...
1. Registra una cuenta en [Vectara](https://vectara.com/integrations/samaflow)
...
5. De vuelta al canvas de SamaFlow, crea tu chatflow. Haz clic en **Create New** desde el menú desplegable de Credentials e ingresa tus credenciales de Vectara.
