...
Si estás ejecutando tanto SamaFlow como Chroma en Docker, hay pasos adicionales involucrados.
...
2. Abre `docker-compose.yml` en SamaFlow
...
4. Inicia la imagen docker de SamaFlow
