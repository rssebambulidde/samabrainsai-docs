---
description: Aprende cómo usar variables en SamaFlow
---
...
SamaFlow permite a los usuarios crear variables que pueden ser utilizadas en los nodos. Las variables pueden ser Estáticas o de Tiempo de Ejecución.
...
Las variables pueden ser utilizadas por los nodos en SamaFlow. Por ejemplo, se crea una variable llamada **`character`**:
