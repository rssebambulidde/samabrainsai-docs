---
description: Aprende cómo usar Multi-Agents en SamaFlow, escrito por @toi500
---

# Multi-Agents

Esta guía pretende proporcionar una introducción a la arquitectura del sistema de IA multi-agente dentro de SamaFlow, detallando sus componentes, restricciones operativas y flujo de trabajo.
...
En SamaFlow, un sistema multi-agente comprende dos nodos principales o tipos de agentes y un usuario, interactuando en un gráfico jerárquico para procesar solicitudes y entregar un resultado específico:
...
* **Un Supervisor por flujo:** Si bien es teóricamente posible implementar un conjunto de sistemas multi-agente anidados para formar una estructura jerárquica más sofisticada para flujos de trabajo altamente complejos, lo que LangChain define como "[Hierarchical Agent Teams](https://github.com/langchain-ai/langgraph/blob/main/examples/multi_agent/hierarchical_agent_teams.ipynb)", con un supervisor de nivel superior y supervisores de nivel medio gestionando equipos de workers, los sistemas multi-agente de SamaFlow actualmente operan con un solo Supervisor.
...
Ahora que hemos establecido una comprensión fundamental de cómo funcionan los sistemas Multi-Agent dentro de SamaFlow, exploremos una aplicación práctica.
...
Aquí encontrarás una lista de tutoriales en video del [canal de YouTube de Leon](https://www.youtube.com/@leonvanzyl) que muestran cómo construir aplicaciones multi-agente en SamaFlow usando no-code.
