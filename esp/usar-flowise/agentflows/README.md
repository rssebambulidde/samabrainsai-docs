---
description: Aprende cómo construir sistemas agénticos en SamaFlow
---

# Agentflows

## Introducción a los Sistemas Agénticos en SamaFlow

La sección Agentflows de SamaFlow proporciona una plataforma para construir sistemas basados en agentes que pueden interactuar con herramientas y fuentes de datos externas.

Actualmente, SamaFlow ofrece dos enfoques para diseñar estos sistemas: [**Multi-Agents**](#user-content-fn-1)[^1] y [**Sequential Agents**](#user-content-fn-2)[^2]. Estos enfoques proporcionan diferentes niveles de control y complejidad, permitiéndote elegir la mejor opción para tus necesidades.

<figure><img src="../../.gitbook/assets/agentflow.png" alt=""><figcaption><p>SamaFlow APP</p></figcaption></figure>
